...
3.  Expand **Azure SQL Database-\> SQL logical servers** and select
    **Create.**
...
4.  Enter the values below and click on **Next: Networking**
    ...
    - Server Name: **azdbsqlserverXXXX** (Replace XXXX with number)

    - Region: region available to your subscription(east us/centralUS)
...
10. Wait for the deployment to be completed, and then click on **Go to
    resource.**
...
1.  Enter the Azure SQL database and select Azure SQL
...
5\. Keep the default values and then click on Next: Networking.

![](./media/image17.png)

6\. Enable Add current client IP address and then click **Review
+create.**
...
8\. Wait for the deployment and click on **Go to resource.**

![](./media/image20.png)

## Exercise 3: Create a database via SSMS and upload csv file.

1.  Double-click on SSMS from task bar and select **Sign in with
    Microsoft**
...
> **Note:** Write any prompt and send it, it will ask you to sign in
> first.

![](./media/image28.png)

6.  Prompt Copilot to create a database “ **@workspace, create a SQL
    Server database named ContosoMedicalResearch with default
...
7.  Wait for the deployment to be successful and click on **Go to
    resource.**
...
17. **Increase the Token per Minute Rate limit and then click on Create
    resource and deploy.**
...
3.  Click **Go to Search Explorer**.

![](./media/image73.png)

4.  Enter the prompts, check vectors and embeddings and verify vectors
...
>
>    "I do not have enough information in the knowledge sources to
> answer this."
>
...
>
> 3\) Provide clear citations (Title or Id) inline like \[1\], \[2\],
> and at the end under "Sources".
>
> 4\) If the tool returns no items, respond exactly:
>
> "I do not have enough information in the knowledge sources to answer
> this."
>
...
>
> \- Then add a short bulleted rationale with specific lines from the
> retrieved passages.
>
...
15\. Expand Tools and select Add.
...
2.  Select the Azure search connection and index, and then click on Add.

![](./media/image101.png)

3.  Select your Azure Search tool and click on Save.

![](./media/image102.png)

16\. Enter the prompts below and check the response
...
15. Enter below prompt

> List books and their authors related to AI in radiology diagnostics

![](./media/image106.png)

16. Switch back to Foundry agent tab and click on **Publish -\> Publish
    agent.**
